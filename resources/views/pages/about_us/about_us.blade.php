...
@section('contents')
    ...
    <section class="xl:my-12 my-6 overflow-hidden">
        <div class="max-w-[1536px] m-auto p-4 flex flex-col ss:gap-y-16 gap-y-8">
            <div class="flex gap-y-8 flex-col justify-center items-center" data-aos="zoom-in" data-aos-duration="3000">
                <p class="w-full text-center font-[400] ss:text-lg text-base text-black ss:tracking-[8px] tracking-widest">
                ...
                <p class="font-light ss:text-lg text-sm text-center w-full text-[#3E3E3E] max-w-[80%]"> Lorem
                    ...
                    eget eget proin hac. Viverra turpis quis a sodales viverra nunc. Penatibus nunc nunc blandit sit. In non
                    amet faucibus in tincidunt porttitor viverra malesuada.
                </p>
            ...
            <div class="swiper swiper-about-us h-auto items-center relative max-w-[1320px] w-full mb-6">
                <div class="swiper-wrapper items-center">
                    {{-- 1 --}}
                    <div class="swiper-slide flex flex-col rounded-sm w-full md:h-[440px] h-[300px]" data-aos="flip-left"
    ...
    <section class=" pb-4 ">
        <div class="max-w-[1536px] m-auto py-8 px-4 flex flex-col justify-center gap-y-8 relative">
            <p class="w-full text-center font-[400] ss:text-lg text-sm text-black ss:tracking-[8px] tracking-widest" data-aos="zoom-in" data-aos-duration="3000">
                F.A.QS
            </p>
            <p class="font-[700] ss:tracking-[8px] sm:text-3xl text-xl text-center capitalize text-black "
                style="text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.2);" data-aos="zoom-in" data-aos-duration="3000">
                Popular Questions
            </p>

            <div class="w-full max-md:pt-4 flex flex-col gap-y-6 ss:mt-6" data-aos="fade-up" data-aos-duration="3000">
                @for ($i = 0; $i < 6; $i++)
                    <div class="flex flex-col items-center py-4 bg-white shadow-md rounded-md p-6"
                        ...
                        <div class="flex justify-between w-full items-center open_q_detail cursor-pointer">
                            ...
                            <div class="w-[30px] h-auto">
                                <img src="/images/icon/Group 575.png" alt=""
                                    class="w-full arrow-icon transition-all duration-500 ease-in-out">
                            </div>
                        </div>
                        ...
                        <div class="transition-all duration-500 ease-in-out max-h-0 opacity-0 overflow-hidden q_detail">
                            <p class="font-[300] sm:text-base text-sm text-left w-full text-[#3E3E3E] pt-6">
                                ...
                                facilisi metus commodo tortor egestas. Odio cursus elit vitae maecenas imperdiet ut egestas
                                orci. Amet at enim proin lacus ut quis. Amet phasellus risus viverra sed in malesuada nec.
                            </p>
                        </div>
