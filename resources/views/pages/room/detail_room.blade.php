...
@section('contents')
    ...
    <section class="z-50 lg:pb-20 pb-10  overflow-hidden">
        <div class="max-w-[1536px] m-auto xl:py-12 py-8 p-4 relative z-50 flex flex-col gap-y-8">
            {{-- 111 --}}
            <div class="flex gap-4 lg:flex-row flex-col gap-y-4">
                <div class="flex sm:flex-col flex-col justify-start gap-4 w-full" data-aos="fade-right"
                    ...
                    <div class="flex flex-col justify-between">
                        <div class="w-full flex justify-between gap-2 sm:flex-row pb-6 ">
                            ...
                            <div class="xmax-w-[320px] xl:h-[180px] sm:h-[120px] max-ss:max-h-[80px] h-auto  w-full hover:scale-95 cursor-pointer"
                                style="box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;">
                ...
                <div class="w-full text-black flex flex-col gap-4" data-aos="fade-left" data-aos-duration="2000">
                    {{-- 1 --}}
                    <div class="w-full 2xl:h-[580px] h-full rounded-sm xl:p-8 p-4 flex flex-col justify-between gap-4 "
                        ...
                        <div
                            class="w-full rounded-full bg-[#03203E] text-white border border-[#03203E] p-2 flex justify-center items-center shadow-md hover:bg-white hover:text-[#03203E] ">
        ...
        <div class="bg-[#03203E] py-12 px-6 flex flex-col gap-6 justify-center items-center z-50">
            ...
            <div class="swiper swiper-room h-auto items-center relative max-w-[1320px] w-full">
                <div class="swiper-wrapper items-center">
                    {{-- 1 --}}
                    <div class="swiper-slide flex flex-col rounded-sm" data-aos="flip-left"
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="absolute w-full bottom-0  opacity-0 transition-opacity duration-300 ease-out group-hover:opacity-100 group-hover:delay-300 group-hover:duration-300"
                                    ...
                                    <a href="/contact"
                                        class="flex justify-center transition-all ease-in-out duration-500 text-white sm:text-lg text-base items-center shadow-md font-light w-full h-full p-3 bg-[#0F1D20]/50 hover:bg-[#0F1D20] backdrop-blur-xs "
